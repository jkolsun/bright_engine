...
/**
 * GBP Lead Scraper — Batch 2
 * Same verticals (roofing, tree service, painting), DIFFERENT cities than Batch 1.
 * 
 * Usage: SERPAPI_KEY=your_key node gbp-lead-scraper-batch2.js
 */
...
const OUTPUT_FILE = process.env.OUTPUT_FILE || `gbp-leads-batch2-${today}.csv`

// DIFFERENT cities from batch 1 — no overlap
const CITIES = [
  'Milwaukee WI',
  'Omaha NE',
  'Albuquerque NM',
...
async function main() {
  console.log('╔══════════════════════════════════════════════════════╗')
  console.log('║  GBP Lead Scraper — BATCH 2                        ║')
  console.log('╚══════════════════════════════════════════════════════╝')
