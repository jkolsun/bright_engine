    ...
    <div className="relative flex-shrink-0 border-t border-gray-200/60 bg-white/95 backdrop-blur-sm px-8 py-3 shadow-[0_-2px_12px_rgba(0,0,0,0.06)]">
      ...
      <div className="flex items-center justify-center flex-wrap gap-x-3 gap-y-1 text-[11px] text-gray-400 mb-2.5 font-medium">
        ...
        <button
          ...
          className={`inline-flex items-center gap-1 cursor-pointer hover:opacity-80 transition-opacity ${isAutoDialOn ? 'text-green-500' : 'text-amber-500'}`}
        >
          {isAutoDialOn ? <Play className="w-3 h-3" /> : <Pause className="w-3 h-3" />}
          <span className="font-bold tracking-wider">{isAutoDialOn ? 'AUTO-DIAL ON' : 'PAUSED'}</span>
        </button>
      </div>
        ...
        {isOnCall ? (
          <>
            ...
            {isVoicemail && (
              <button
                ...
                className="w-12 h-12 rounded-xl flex items-center justify-center bg-purple-100 text-purple-600 hover:bg-purple-200 disabled:opacity-50 transition-all duration-200"
          ...
          <>
            <button
              ...
              className="flex items-center justify-center gap-3 px-14 py-3.5 gradient-primary text-white rounded-2xl font-bold text-sm hover:opacity-90 shadow-lg shadow-teal-500/20 disabled:opacity-40 disabled:cursor-not-allowed disabled:shadow-none transition-all duration-200"
            ...
            {showManualDial && (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-teal-600 text-white rounded-xl text-sm font-bold hover:bg-teal-700 disabled:opacity-50 transition-all duration-200 shadow-sm"
                >
