            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-8 mb-8">
                  <div><p className="font-display text-3xl font-bold text-teal-600">{hasRating ? lead.enrichedRating : '5.0'}</p><p className="text-[11px] uppercase tracking-[0.2em] text-gray-400 mt-1">Star Rating</p></div>
                  {lead.enrichedReviews && (<div><p className="font-display text-3xl font-bold text-teal-600">{lead.enrichedReviews}+</p><p className="text-[11px] uppercase tracking-[0.2em] text-gray-400 mt-1">Reviews</p></div>)}
                  <div><p className="font-display text-3xl font-bold text-teal-600">100%</p><p className="text-[11px] uppercase tracking-[0.2em] text-gray-400 mt-1">Satisfaction</p></div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <div className="mt-10 flex flex-wrap gap-12">
                  <div><p className="font-display text-4xl font-bold text-teal-600">{hasRating ? lead.enrichedRating : '5.0'}</p><p className="text-[11px] uppercase tracking-[0.2em] text-gray-400 mt-2">Star Rating</p></div>
                  {lead.enrichedReviews && (<div><p className="font-display text-4xl font-bold text-teal-600">{lead.enrichedReviews}+</p><p className="text-[11px] uppercase tracking-[0.2em] text-gray-400 mt-2">Reviews</p></div>)}
                  <div><p className="font-display text-4xl font-bold text-teal-600">100%</p><p className="text-[11px] uppercase tracking-[0.2em] text-gray-400 mt-2">Satisfaction</p></div>
                </div>
              </div>
              </ScrollReveal>
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gray-50/50">
          <div className="max-w-6xl mx-auto">
            ...
            <div className={testimonials.length === 1 ? 'max-w-2xl mx-auto' : 'grid grid-cols-1 md:grid-cols-2 gap-6'}>
              ...
              <ScrollReveal key={i} animation="fade-up" delay={i * 100}>
              <div className="bg-white border border-gray-100 rounded-2xl p-7 hover:border-teal-200 transition-all">
