        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="flex items-center justify-between h-[68px]">
            ...
            <div className="flex items-center gap-3">
              ...
              {lead.phone && (<a href={`tel:${lead.phone}`} onClick={onCallClick} className={`hidden lg:flex items-center gap-2 text-sm font-medium transition-colors ${scrolled ? 'text-stone-500 hover:text-stone-800' : 'text-white/70 hover:text-white'}`}><Phone size={14} />{formatNavPhone(lead.phone)}</a>)}
