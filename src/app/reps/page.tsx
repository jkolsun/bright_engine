      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-3">
          <Link href="/reps/dialer?mode=single">
            <Button variant="outline" className="gap-2 rounded-xl border-gray-200 hover:border-teal-300 hover:bg-teal-50/50 transition-all">
              <PhoneCall size={18} className="text-teal-600" /> Single Dial
            </Button>
          </Link>
      ...
      <Card className="p-6 rounded-2xl border-0 shadow-medium bg-white/80 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-3 gap-8 mb-5">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1 font-medium uppercase tracking-wide">Dials</p>
          </div>
          <div>
            <div className="flex items-baseline gap-2">
      ...
      <Card className="p-6 rounded-2xl border-0 shadow-medium bg-white/80 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <Link href="/reps/tasks">
            <Button variant="outline" className="w-full rounded-xl border-gray-200 hover:border-teal-300 hover:bg-teal-50/50 transition-all h-12">
              <Target size={18} className="mr-2 text-teal-600" />
              Tasks
            </Button>
          </Link>
        </div>
