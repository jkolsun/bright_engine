        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="text-center max-w-md">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <a href="/part-time" className="px-6 py-2.5 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 rounded-xl font-semibold text-sm hover:bg-gray-50 dark:hover:bg-slate-800">
                Back to Dashboard
              </a>
            </div>
          </div>
