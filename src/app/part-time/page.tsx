    ...
    <div className="p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href="/part-time/dialer">
          <Button className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white gap-2 shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-6">
          ...
          <div className="text-3xl font-bold text-gray-900">{formatCurrency(assignedLeads.length * 149)}</div>
        </Card>
      </div>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Your Assigned Leads ({assignedLeads.length})</h3>
        </div>
              ...
              <tbody className="divide-y divide-gray-200">
                {assignedLeads.map((lead) => (
                  <tr key={lead.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-4">
                      {lead.industry && (
                        <Badge variant="outline" className="text-xs">{lead.industry.replace(/_/g, ' ')}</Badge>
                      )}
                    </td>
                    <td className="p-4">
                      <Badge variant={
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-1">
                        {lead.previewUrl && (
                          <>
                            <Button variant="ghost" size="sm" className="text-blue-600"
                              onClick={() => handleTextPreview(lead)} title="Text preview">
                              <MessageSquare size={14} />
                            </Button>
                            <Button variant="ghost" size="sm"
                              onClick={() => handleCopyPreview(lead.id, lead.previewUrl)} title="Copy preview link">
                              {copiedId === lead.id ? <CheckCircle size={14} className="text-green-600" /> : <Copy size={14} />}
                            </Button>
                        ...
                        <Button variant="ghost" size="sm" onClick={() => openEditDialog(lead)} title="Edit lead info">
                          <Edit3 size={14} />
                        </Button>
                      </div>
                    </td>
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <Link href="/part-time/dialer">
            <Button variant="outline" className="w-full"><Phone size={18} className="mr-2" /> Dialer</Button>
          </Link>
          <Link href="/part-time/earnings">
            <Button variant="outline" className="w-full"><DollarSign size={18} className="mr-2" /> Earnings</Button>
          </Link>
          <Link href="/part-time/tasks">
            <Button variant="outline" className="w-full"><Target size={18} className="mr-2" /> Tasks</Button>
          </Link>
        </div>
      </Card>
